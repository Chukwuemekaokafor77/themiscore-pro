    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <section className="rounded border bg-white p-4">
        ...
        <form id="upload" action="/api/documents/upload" method="post" encType="multipart/form-data" className="grid gap-3 max-w-xl">
          ...
          <div>
            <label className="block text-sm text-gray-600 mb-1">Case ID (optional)</label>
            <input type="number" name="case_id" className="w-full border rounded px-3 py-2" />
          </div>
          <div>
          ...
          <p className="text-xs text-gray-500">After upload, refresh the page to see the new document.</p>
        </form>
      </section>
